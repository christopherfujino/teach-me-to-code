...
"jobs": [
  {
    ...
    "role": "Tech Lead, Flutter Engineering Productivity",
    "description": "<div class=p>Flutter</a> is Google's open source, cross-platform application framework allowing a single codebase to target Android, iOS, Windows, macOS, Linux, and the web.</div><div class=p></li>"
  },
  {
    "company": "Google",
